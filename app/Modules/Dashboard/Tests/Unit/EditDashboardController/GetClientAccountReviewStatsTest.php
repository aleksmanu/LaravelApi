...
class GetClientAccountReviewStatsTest extends BaseTestClass
{
    ...
    /**
     * @see EditDashboardController::getClientAccountReviewStats()
     */
    public function test()
    {

        $result = $this->apiAs($this->user, 'GET', '/api/dashboard/edit/client-account-review-stats', []);
